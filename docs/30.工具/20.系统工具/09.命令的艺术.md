...
::: center
![curl -s 'https://raw.githubusercontent.com/jlevy/the-art-of-command-line/master/README.md' | egrep -o '`\w+`' | tr -d '`' | cowsay -W50](https://cdn.staticaly.com/gh/xingcxb/blog_img@blog1/工具/系统工具/命令的艺术/cowsay.png)
:::

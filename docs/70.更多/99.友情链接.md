...
- name: LINUX DO
  desc: 「新的理想型社区」
  avatar: https://cdn.jsdelivr.net/gh/xingcxb/blog_img@blog1/友链/Linux.do.png # 可选
  link: https://linux.do/?source=xingcxb_com# 可选
...
- name: 奥利弗的狗窝
  desc: 「读书写字，对抗虚无，消耗时间」
  avatar: https://Oliverwqcwrw.github.io/picx-images-hosting/20240613/head1.6t6yz363l2.webp # 可选
  link: https://www.aolifu.org/# 可选
  bgColor: "#c7eaf9" # 可选，默认var(--bodyBg)。颜色值有#号时请添加单引号
  textColor: "#ffb34b" # 可选，默认var(--textColor)
```
